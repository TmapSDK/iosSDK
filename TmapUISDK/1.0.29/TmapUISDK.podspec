Pod::Spec.new do |s|
  ...
  s.source                = { :http => "https://devrepo.tmapadmin.com/repository/tmap-sdk-release-ios/TmapUISDK%2F1.0.29%2FTmapUISDK.xcframework.zip" }
  ...
  s.dependency 'TmapNaviSDK', '1.0.29'
